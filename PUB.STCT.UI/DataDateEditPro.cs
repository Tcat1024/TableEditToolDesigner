...
namespace PUB.STCT.Client
{
    ...
    public partial class DataDateEditPro : XtraUserControl, DataBaseEditPro
    {
        private void BaseEdit_ParseEditValue(object sender, DevExpress.XtraEditors.Controls.ConvertEditValueEventArgs e)
        {
            e.Handled = true;
        }
